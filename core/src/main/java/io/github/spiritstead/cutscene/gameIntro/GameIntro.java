...
public class GameIntro implements Cutscene {
    ...
    public GameIntro(GamePanel gp) {
        ...
        slides.add(new ContentSlide(gp, this, "intro/introSlide.png", new ArrayList<>(gp.system.script.getChapter1().get(1))));
        slides.add(new ContentSlide(gp, this, "intro/introSlideCharacter.png", new ArrayList<>(gp.system.script.getChapter1().get(2))));
        slides.add(new ContentSlide(gp, this, "intro/forrestTrail.png", new ArrayList<>(gp.system.script.getChapter1().get(3))));
